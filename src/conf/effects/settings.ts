...
export const disableDisplayVideo =
  ({ media }: RootStore) =>
  () => {
...
export const changeAudioDeviceId =
  ({ media, ui }: RootStore) =>
...
export const changeVideoDeviceId =
  ({ media, ui }: RootStore) =>
  async (deviceId: string) => {
